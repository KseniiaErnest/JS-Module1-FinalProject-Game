...
function getNewQuestion() {
  ...
  // Get random question without repeating
  const randomIndex = Math.floor(Math.random() * avaibleQuestions.length);
  currentQuestion = avaibleQuestions[randomIndex];
  avaibleQuestions.splice(randomIndex, 1);
